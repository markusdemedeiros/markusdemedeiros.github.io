...
-- NOTE!!!!!
-- https://stackoverflow.com/questions/42080807/purescript-how-can-i-run-a-dom-event-listener-callback-within-a-monadic-contex
-- This is the strategy I want to try on this branch
-- Coroutines + maybe some custom FFI stuff to manipulate the DOM if purescript-dom doesn't handle it
--  although I'm not certain it doesn't.
