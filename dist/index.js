...
(function($PS) {
  ...
  var NonEnter = (function () {
      function NonEnter() {

      };
      NonEnter.value = new NonEnter();
      return NonEnter;
  })();
  ...
  var handleAction = function (dictMonadEffect) {
      return function (v) {
          if (v instanceof NonEnter) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v instanceof Enter) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))($foreign.clearById("console-inp")))(function (s) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Effect_Console.log(s)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(handleCommand(s)))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (new_st) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))($foreign.setById("console-disp")(new_st.console)))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              });
                          });
                      });
          ...
          throw new Error("Failed pattern match at Main (line 70, column 1 - line 73, column 44): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadEffect) {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.spellcheck(false), Halogen_HTML_Properties.rows(25), Halogen_HTML_Properties.id("console-disp"), Halogen_HTML_Properties.placeholder(state.console), Halogen_HTML_Properties.readOnly(true) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.spellcheck(false), Halogen_HTML_Properties.placeholder(" >> "), Halogen_HTML_Properties.id("console-inp"), Halogen_HTML_Events.onKeyDown(function (ev) {
              var $6 = Web_UIEvent_KeyboardEvent.code(ev) === "Enter";
              if ($6) {
                  return Enter.value;
              };
              return NonEnter.value;
          }) ]) ]);
      };
      var initialState = {
          console: "Type something below!"
      };
  ...
  exports["main"] = main;
  exports["Enter"] = Enter;
  exports["NonEnter"] = NonEnter;
  exports["component"] = component;
  exports["handleAction"] = handleAction;
  exports["handleCommand"] = handleCommand;
  exports["clearById"] = $foreign.clearById;
  exports["setById"] = $foreign.setById;
})(PS);
PS["Main"].main();