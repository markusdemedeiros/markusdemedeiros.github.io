...
(function($PS) {
  ...
  var ConsoleInput = (function () {
      function ConsoleInput(value0) {
          this.value0 = value0;
      };
      ConsoleInput.create = function (value0) {
          return new ConsoleInput(value0);
      };
      return ConsoleInput;
  })();
  var handleAction = function (v) {
      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
          ...
          $4.value = "Echo: " + v.value0;
          return $4;
      });
  };
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.spellcheck(false), Halogen_HTML_Properties.rows(25), Halogen_HTML_Properties.id("console-disp"), Halogen_HTML_Properties.placeholder(state.value), Halogen_HTML_Properties.readOnly(true) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.spellcheck(false), Halogen_HTML_Properties.placeholder(" >> "), Halogen_HTML_Properties.id("console-inp"), Halogen_HTML_Events.onValueChange(function (s) {
              return new ConsoleInput(s);
          }) ]) ]);
      };
      var initialState = {
